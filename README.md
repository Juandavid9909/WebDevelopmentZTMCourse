...
| open -a “Sublime Text” index.html   | opens the file we selected |
...
C:\Program Files\Sublime Text 4 - open Sublime Text
```

### **FOR WINDOWS WITH GIT BAH:**


```cmd
echo 'alias subl="/C/Program\ Files/Sublime\ Text\ 3/sublime_text.exe"' >> ~/.bashrc - create alias
subl - use an alias
```
